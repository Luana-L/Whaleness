...
extension Appointment {
    static var MOCK_APPT: [Appointment] = [
        Appointment(date: Date(month: 10, day: 8, year: 2023, hour: 9, minute: 00), location: "Mt. Sinai Morningside", doctor: "Stan Bradley"),
        Appointment(date: Date(month: 11, day: 10, year: 2023, hour: 16, minute: 00), location: "Uptown Dental Group", doctor: "Phoebe Lewis"),
